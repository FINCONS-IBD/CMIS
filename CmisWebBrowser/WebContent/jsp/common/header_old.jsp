...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.0.4/css/bootstrap-combined.min.css"></link>
     -->
...
<div id="navbar" class="navbar navbar-fixed-top" data-scrollspy="scrollspy">
       ...
       <div class="container" style="width: 60%; float: left; text-align: center">
           <ul class="nav" style="width: 100%;">
           	<img src="public/images/banner_2.png" style="width: 500px, margin:15px 5px 0px 15px"/><!-- <h2>CMIS Knowledge Browser</h2>-->
